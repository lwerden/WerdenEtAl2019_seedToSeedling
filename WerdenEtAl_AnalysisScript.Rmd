...
depositionRateSummary_byPlot_mod_simp <- seedRain_DepRates %>%
                         group_by(Site, Treatment, Plot, seedSizeCat) %>%
...
Figure1 <- ggboxplot(depositionRateSummary_byPlot_mod_simp[complete.cases(depositionRateSummary_byPlot_mod_simp),],
                                        x = "Treatment", 
                                        y = "depositionRate", 
                                        fill = "Treatment", 
                                        palette =CB_YlGnBu,
...
Figure1 <- facet(fig_depositionRate_Ms, facet.by = c("seedSizeCat"),
                                     panel.labs = list(
...
ggsave("Figure1.pdf", width = 6, height = 6, dpi = 600, units = "in", device=cairo_pdf)
```
