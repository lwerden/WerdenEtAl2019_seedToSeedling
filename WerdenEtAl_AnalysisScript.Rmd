...
seedRain_sourceLimitationCalcs <- seedRain_All_byTreat_station %>% 
                       ...
                       summarize(# total number seeds per species
                                 ...
                                 # 60 traps (5 sites) 
                                 mutate(sourceLimitation=ifelse(Treatment == "C" | Treatment == "I" | Treatment == "P", exp(-(totalSeeds/20)), sourceLimitation)) %>% 
                                 # 36 traps (3 sites) 
                                 mutate(sourceLimitation=ifelse(Treatment == "R", exp(-(totalSeeds/12)), sourceLimitation))
